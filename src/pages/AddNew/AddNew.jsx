    ...
    render() {
        return (
            <div style={{ display: "flex", justifyContent: "space-between"}}>
                <div style={{ display: "flex", flexDirection: "column", flexBasis: "28rem" }}>
                ...
                <div style={{ paddingRight: "4.8rem" }}>
                    <div style={{ display: "flex" }}>
                        ...
                        <div style={{ display: "flex", alignContent: "center", flexDirection: "column" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", marginTop: "2.2rem" }}>
                                <Typography color="white" opacity="low" size="body-big">Name</Typography>
                                <Typography color="white" size="body-big">Bumblebee</Typography>
                            </div>
                            <div style={{ display: "flex", flexDirection: "column", marginTop: "2.2rem" }}>
                                <Typography color="white" opacity="low" size="body-big">Faction</Typography>
                                <Typography color="white" size="body-big">Autobots</Typography>
                            </div>
                            <div style={{ display: "flex", flexDirection: "column", marginTop: "2.2rem" }}>
                                <Typography color="white" opacity="low" size="body-big">Status</Typography>
                    ...
                    <div style={{ display: "flex", marginTop: "4.2rem", justifyContent: "space-between" }}>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                            <Typography color="white" opacity="low" size="body-big">Vehicle</Typography>
                            <span style={{ 
                        ...
                        <div style={{ display: "flex", flexDirection: "column" }}>
                            <Typography color="white" opacity="low" size="body-big">Gear</Typography>
                            <span style={{ 
